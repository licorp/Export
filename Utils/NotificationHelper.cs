...
namespace ProSheetsAddin.Utils
{
    public static class NotificationHelper
    {
        ...
        private static readonly string LogFile = Path.Combine(LogFolder, $"ProSheets_{DateTime.Now:yyyy-MM-dd}.log");
        ...
        public static void ClearOldLogs(int daysToKeep = 30)
        {
            try
            {
                ...
                {
                    var files = Directory.GetFiles(LogFolder, "ProSheets_*.log");
